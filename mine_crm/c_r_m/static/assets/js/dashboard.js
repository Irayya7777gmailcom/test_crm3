(function($) {
  ...
  $(function() {
    ...
    // activities chart
    if ($("#activities_chart").length) {
      Chart.defaults.global.legend.labels.usePointStyle = true;
      var ctx = document.getElementById('activities_chart').getContext("2d");
      ...
      gradientStrokeOrange.addColorStop(1, 'rgba(255, 69, 0, 1)');
      var gradientLegendOrange = 'linear-gradient(to right, rgba(255, 165, 0, 1), rgba(255, 69, 0, 1))';
      ...
      $("#activities_chart-legend").html(myChart.generateLegend());
    }
...
// course chart
    if ($("#visit-sale-chart").length) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['New Leads', 'Followup Leads', 'Prospects', 'Regsitered', 'Closed'],
            datasets: [
              {
                label: "Python",
                borderColor: gradientStrokeViolet,
    ...
    if ($("#Employee-chart").length) {
        ...
        data: {
            ...
            datasets: [
              ...
              },
              {
                ...
                hoverBackgroundColor: gradientStrokeOrange,
                legendColor: gradientLegendOrange,
                pointRadius: 0,
                fill: false,
                borderWidth: 1,
                fill: 'origin',
      ...
      $("#Employee-chart-legend").html(myChart.generateLegend());
    }
